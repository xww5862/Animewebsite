...
public class UserServiceImpl implements IUserService {
    ...
    @Override
    public List<TUser> getUserAndFan() {
        return userMapper.getUserAndFan();
    }
    ...
    @Override
    public int updateuserinfovip(Long userId) {
        return userMapper.updateuserinfovip(userId);
    }

    @Override
    public TUser getUserByUserIphone(String userTel) {
        return userMapper.getUserByUserIphone(userTel);
    }
    ...
    public TUser getNowStateId(Long userId) {
        return userMapper.getNowStateId(userId);
    }
